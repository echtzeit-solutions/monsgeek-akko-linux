...
/*
 * Working battery descriptor with dummy input.
 *
 * The kernel only creates power_supply when an input device exists.
 * We add Battery Strength as Input report (not Feature) plus a dummy
 * modifier key to force input device creation.
 *
